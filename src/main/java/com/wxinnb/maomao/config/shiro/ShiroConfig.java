package com.wxinnb.maomao.config.shiro;

import com.wxinnb.maomao.service.IResourceService;
...
public class ShiroConfig {
	...
	public ShiroFilterFactoryBean getShiroFilterFactoryBean(DefaultSecurityManager securityManager, Realm realm) {
		...
		List<com.wxinnb.maomao.domain.Resource> list = resourceService.findAll();
		for (com.wxinnb.maomao.domain.Resource resource : list) {
