			...
			$("#table_list").bootstrapTable({
			    ...
			    ,{
                    ...
                    formatter: function (value, row, index) {
                    	...
                    	operateHtml = operateHtml + '<button class="btn btn-info btn-xs" type="button" onclick="icon(\''+row.productId+'\')"><i class="fa fa-arrows"></i>&nbsp;添加图标</button>&nbsp;';
                        operateHtml = operateHtml + '<button class="btn btn-info btn-xs" type="button" onclick="rollPic(\''+row.productId+'\')"><i class="fa fa-arrows"></i>&nbsp;添加轮播图</button>'
                        return operateHtml;
                    }
			    }]
			});
