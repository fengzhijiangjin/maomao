            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                            ...
                            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
                                <span class="clear">
                                    <span class="block m-t-xs" style="font-size:20px;">
                                        ...
                                        <strong class="font-bold">maomao后台</strong>
                                    </span>
                                </span>
                            </a>
                        </div>
                    ...
                    <li>
                        ...
                        <#--<@shiro.hasPermission name="system:resource:index">-->
                            <li>
                                <a class="J_menuItem" href="/form/admin/index">订单管理</a>
                            </li>
                        <#--</@shiro.hasPermission>-->
                        </ul>
                    </li>
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li class="dropdown">
                            <a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
                                ...
                                <#--【<@shiro.principal type="net.sppan.base.entity.User" property="nickName"/>】-->
                            </a>
                                ...
                                <li>
                                    <a onclick="updatePwd()">
                                        <div>
                                            ...
                                            <#--<@shiro.principal type="net.sppan.base.entity.User" property="userName"/>-->
                                            </span>
                                        </div>
                                    </a>
                                </li>
